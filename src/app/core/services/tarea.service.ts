...
export class TareaService {
  private readonly BASE = 'http://100.59.223.50:8080/api/v1/tareas';
  ...
  porDepartamentoHechas(idDepartamento: string): Observable<TareaHecha[]> {
    return this.http
      .get<ApiResponse<TareaHecha[]>>(`http://100.59.223.50:8080/api/v1/historial/tareas/departamento/${idDepartamento}`)
      .pipe(map(r => r.data));
  }
